...
function getProject(projectDir, projectName, deps) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (projectFile) {
            try {
                projectDetails = yield project_1.determineProjectDetails(projectDir, projectName, projectFile, deps);
            }
            catch (e) {
                log.warn(e.toString());
                log.nl();
        ...
        return project_1.createProjectFromType(projectFilePath, name, deps, type);
    });
}
...
function generateIonicEnvironment(ctx, pargv) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const project = yield getProject(projectDir, projectName, deps);
        if (project) {
