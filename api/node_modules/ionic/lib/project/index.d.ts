...
export declare function determineProjectDetails(rootProjectDir: string, projectName: string | undefined, projectConfig: {
    [key: string]: any;
} | undefined, deps: ProjectDeps): Promise<ProjectDetails | undefined>;
